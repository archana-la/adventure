        ...
        <>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 shadow">
                            ...
                            <h6 className='py-2 text-dark'>Everest Base Camp Trek via Gokyo Lakes</h6>
                            </Link> 
                            <p>18 days</p>
                            <div className="row">
                                <div className="col-lg-6">
                        ...
                        <div className="col-lg-4 shadow">
                            ...
                            <h6 className='py-2 text-dark'>Annapurna Base Camp via Poon Hill (Sanctuary Trek)</h6>
                            </Link>
                            <p>15 days</p>
                            <div className="row">
                                <div className="col-lg-6">
            ...
            <section className='py-4'>
                <div className="container">
                    ...
                    <div className="row ">
                        <div className="col-lg-4 shadow">
                        <Link className='text-decoration-none' href={'/Nepal'}>
                            <img className='g rounded' src="https://vajraadventure.com/storage/blog/trekking.jpg" alt="" />
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h6 className='py-2 text-dark'>Trekking Nepal with us</h6>
                                    </div>
                                    <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
                                    </div>
                                </div>
                            </Link>
                        ...
                        <div className="col-lg-4 shadow">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                <h6 className='py-2 text-dark'>Tours in Nepal with us</h6>
                                </div>
                                  <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
                        ...
                        <Link className='text-decoration-none' href={'/Nepal'}>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                <h6 className='py-2 text-dark'>Short Hiking in Nepal</h6>
                                </div>
                                <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
                        ...
                        <div className="col-lg-4 py-3 shadow">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                <h6 className='py-2 text-dark'>Yoga Trekking in Nepal</h6>
                                </div>
                                <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
                        ...
                        <div className="col-lg-4 py-3 shadow">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                <h6 className='py-2 text-dark'>Peak Climbing Packages</h6>
                                </div>
                                <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
                        ...
                        <div className="col-lg-4 py-3 shadow">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                <h6 className='py-2 text-dark'>Mountain Biking Nepal</h6>
                                </div>
                                <div className="col-lg-6 text-end">
                                        <h5 className='text-dark'>Explor <FaArrowRight />
                                        </h5>
            ...
            <section className='p py-4'>
                <div className="container">
                   ...
                   <form className="" role="search">
                        <div className="input-group">
                            <input className="form-control  me-3" type="search" placeholder="Your email address" aria-label="search" />
                            <button className="btn text-white ff" type="submit">Subscribe Now
                            </button>
                        </div>
                    </form>
